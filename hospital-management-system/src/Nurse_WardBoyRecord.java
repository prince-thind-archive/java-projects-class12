...
ResultSet rs=null;
 ...
 private void Get_Data(){
        String sql="select ID, W_N_name"
                + " as 'Name',Category,Address,ContactNo as"
                + " 'Contact No',Email as 'Email ID',Qualifications,BloodGroup "
                + "as 'Blood Group',DateOfJoining as 'Joining Date' "
                + "from Wardboy_Nurse_tbl order by W_N_name";
        try{
...
String i = rs.getString("Joining Date");
model.addRow (new Object[] {a,b,c,d,e,f,g,h,i});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Category", "Address", "Contact No", "Email ID", "Qualifications", "Blood Group", "Joining Date"
            }
        ));
