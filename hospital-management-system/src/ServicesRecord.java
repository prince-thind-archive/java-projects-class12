...
ResultSet rs=null;
 ...
 private void Get_Data(){
       String sql="select ServiceID as 'Service ID', ServiceName as "
               + "'Service Name',ServiceDate as 'Service Date',"
               + "PatientRegistration.PatientID as 'Patient ID',"
               + "PatientName as 'Patient Name',ServiceCharges as "
               + "'Service Charges' from PatientRegistration,Services"
               + " where Services.PatientID=PatientRegistration.PatientID order by serviceid";
       try{         
...
Statement stmt = con.createStatement();
          ...
          while(rs.next())
{
String a = rs.getString("Service ID");
String b = rs.getString("Service Name");
String c = rs.getString("Service Date");
String d = rs.getString("Patient ID");
String e = rs.getString("Patient Name");
String f = rs.getString("Service Charges");
model.addRow (new Object[] {a,b,c,d,e,f,});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Service ID", "Service Name", "Service Date", "Patient ID", "Patient Name", "Service Charges"
            }
        ));
