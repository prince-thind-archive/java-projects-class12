...
ResultSet rs=null;
 ...
 private void Get_Data(){
      String sql="select DoctorID as 'Doctor ID', DoctorName as"
              + " 'Doctor Name',FatherName as 'Father Name',"
              + "Address,ContactNo as 'Contact No',Email as"
              + " 'Email ID',Qualifications,Specialization,"
              + "Gender,BloodGroup as 'Blood Group',DateOfJoining "
              + "as 'Joining Date' from Doctor order by Doctorid";
      try{
...
String c = rs.getString("Father Name");
String d = rs.getString("Address");
String e = rs.getString("Contact No");
String f = rs.getString("Email ID");
String g = rs.getString("Qualifications");
String h = rs.getString("Specialization");
String i = rs.getString("Gender");
String j = rs.getString("Blood Group");
String k = rs.getString("Joining Date");
model.addRow (new Object[] {a,b,c,d,e,f,g,h,i,j,k});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Doctor ID", "Doctor Name", "Father Name", "Address", "Contact No", "Email ID", "Qualifications", "Specialization", "Gender", "Blood Group", "Joining Date"
            }
        ));
