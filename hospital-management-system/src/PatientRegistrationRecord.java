...
ResultSet rs=null;
 ...
 private void Get_Data(){
           String sql="select PatientID as 'Patient ID', "
                   + "PatientName as 'Patient Name',FatherName "
                   + "as 'Father Name',Address,ContactNo as"
                   + " 'Contact No',Email as 'Email ID',Age,Gen as"
                   + " 'Gender',BG as 'Blood Group',Remarks from Patientregistration" +
                   " order by PatientID;";
           try{
...
String h = rs.getString("Blood Group");
String i = rs.getString("Remarks");
model.addRow (new Object[] {a,b,c,d,e,f,g,h,i});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "Patient Name", "Father Name", "Address", "Contact No", "Email ID", "Gender", "Blood Group", "Remarks"
            }
        ));
