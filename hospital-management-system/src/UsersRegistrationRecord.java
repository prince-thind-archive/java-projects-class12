...
ResultSet rs=null;
  ...
  private void Get_Data(){
        String sql="select NameOfUser as 'Name', UserName as 'User Name',Password,ContactNo as "
                + "'Contact No',Email as 'Email ID' from Registration";
        try{
...
String b = rs.getString("User Name");
String c = rs.getString("Password");
String d = rs.getString("Contact No");
String e = rs.getString("Email ID");
