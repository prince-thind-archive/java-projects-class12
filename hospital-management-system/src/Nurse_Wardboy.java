...
private void Reset()
{
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Nurse/Wardboy Info", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Bell MT", 0, 12))); // NOI18N
        ...
        btnUpdate.setFont(new java.awt.Font("Castellar", 0, 12)); // NOI18N
        ...
        btnGetData.setFont(new java.awt.Font("Castellar", 0, 12)); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/nurse.jpg"))); // NOI18N
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try{
            ...
            String sql= "update Wardboy_Nurse_tbl set W_N_name='"+ txtName.getText() + "',Category='"+ 
                    cmbCategory.getSelectedItem()+ "',Email='"+ txtEmailID.getText() + "',ContactNo='"+
                    txtContactNo.getText() + "',Qualifications='"+ txtQualifications.getText() + "',BloodGroup='"+
                    cmbBloodGroup.getSelectedItem() + "',DateOfJoining='" + txtDateOfJoining.getText() + "',Address='"
                    + txtAddress.getText() + "' where ID='" + txtID.getText() + "'";
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
            ...
            String sql= "insert into Wardboy_Nurse_tbl(ID,W_N_name,Category,Email,ContactNo,Qualifications,BloodGroup," +
                    "DateOfJoining,Address)values('"+ txtID.getText() + "','"+ txtName.getText() + "','"+
                    cmbCategory.getSelectedItem()+ "','"+ txtEmailID.getText() + "','"+ txtContactNo.getText() + "','"+
                    txtQualifications.getText() + "','"+ cmbBloodGroup.getSelectedItem() + "','" + txtDateOfJoining.getText() +
                    "','" + txtAddress.getText() + "')";
            Statement stmt1 = (Statement) con.createStatement();
            stmt1.executeUpdate(sql);
